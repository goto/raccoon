...
func NewGRPCService(c collection.Collector, policy *policypkg.Service, dedup *dedup.Service) *Service {
	server := newGRPCServer()
	pbgrpc.RegisterEventServiceServer(server, &Handler{C: c, policy: policy, dedup: dedup})
